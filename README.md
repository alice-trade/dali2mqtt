...
*   **Гибкая настройка через Web-интерфейс**: Встроенный веб-сервер для простой настройки WiFi/MQTT, а также для управления шиной DALI (сканирование, инициализация).
