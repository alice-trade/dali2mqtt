...
namespace daliMQTT
{
     ...
     * @param addr 24-битный long address.
     * @return std::array<char, 7> с null-терминированной строкой (e.g., "A1B2C3").
     */
    inline LongAddrStr longAddressToString(const DaliLongAddress_t addr) {
        ...
        result[6] = '\0'; // Null-terminator
        return result;
    }

    /**
     * @brief Конвертирует строковое HEX представление в DaliLongAddress.
     * @param s Строковое представление (e.g., "A1B2C3").
     * @return Optional DaliLongAddress.
     */
